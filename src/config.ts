...
const secrectKey = process.env.API_KEY;
const host =
  process.env.PROD === 'true' ? process.env.HOST_PROD : process.env.HOST_LOCAL;
const urlWebHook =
  process.env.PROD === 'true'
    ? process.env.WEBHOOK_PROD
    : process.env.WEBHOOK_LOCAL;
...
export default {
  ...
  port: '21465',
  deviceName: 'BotSync',
  poweredBy: 'BotSync Oficial',
  startAllSession: true,
  tokenStoreType: 'file',
  maxListeners: 16,
  customUserDataDir: './sessions/',
  webhook: {
    url: urlWebHook,
    autoDownload: true,
    uploadS3: false,
